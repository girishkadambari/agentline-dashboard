    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border bg-surface p-7 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Phone infrastructure for AI agents.</p>
          <Link
            to="/auth/callback"
            className="mt-6 flex w-full items-center justify-center gap-2.5 rounded-md border bg-surface px-3 py-2.5 text-sm font-medium hover:bg-muted"
          >
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          New to AgentLine? Your workspace is created on first sign-in.
        </p>
      </div>
    </div>
  );
