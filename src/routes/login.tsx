      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border bg-surface p-7 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Connect this dashboard to your local AgentLine backend.
          </p>
          <form className="mt-6 space-y-4" onSubmit={submit}>
            ...
            <button
              ...
              className="flex w-full items-center justify-center rounded-md bg-foreground px-3 py-2.5 text-sm font-medium text-background hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <button
            type="button"
            disabled
            className="mt-3 flex w-full cursor-not-allowed items-center justify-center gap-2.5 rounded-md border bg-surface px-3 py-2.5 text-sm font-medium opacity-60"
          >
            ...
            Google SSO coming next
          </button>
          <p className="mt-6 text-center text-xs text-muted-foreground">
            Local default: sk_test_agentline_local
          </p>
        </div>
        <p className="mt-4 text-center text-xs text-muted-foreground">
          Start the NestJS backend first, then sign in with a seeded API key.
        </p>
      </div>
    </div>
  );
