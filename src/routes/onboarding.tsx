        ...
        <div className="rounded-xl border bg-surface p-7">
          ...
          {step === 0 && (
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Three quick steps: create an agent, attach a number, test a call or SMS.
              </p>
              <label className="mt-6 block text-sm font-medium">Workspace name</label>
              <input
                value={workspace}
                onChange={(e) => setWorkspace(e.target.value)}
                className="mt-1.5 w-full rounded-md border bg-surface px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
              />
            </div>
          )}
          {step === 1 && (
                    ...
                    {(["hosted", "webhook", "web"] as const).map((m) => (
                      <button
                        ...
                        className={cn(
                          ...
                          mode === m ? "border-foreground bg-muted" : "hover:bg-muted/50",
                        )}
                      >
          ...
          {step === 2 && (
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Webhooks let your backend control the agent. You can add this later.
              </p>
              ...
              <input
                ...
                placeholder="https://your-domain.com/webhooks/vukho"
                className="mt-1.5 w-full rounded-md border bg-surface px-3 py-2 text-sm font-mono"
              />
            </div>
          )}
          {step === 3 && (
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Your workspace and first agent are ready.
              </p>
